...
var PDFViewerApplication = {
  ...
  load: function pdfViewLoad(pdfDocument, scale) {
    ...
    pdfDocument.getPageLabels().then(function (labels) {
      ...
      self.toolbar.setPagesCount(pdfDocument.numPages, false);
...
function webViewerInitialized() {
  ...
  appConfig.sidebar.backButton.addEventListener('click', function () {
...
var ViewHistory = function ViewHistoryClosure() {
  ...
  ViewHistory.prototype = {
    ...
    _readFromStorage: function ViewHistory_readFromStorage() {
      return new Promise(function (resolve) {
          var value = null;//localStorage.getItem('pdfjs.history');
        if (!value) {
...
function getViewerConfiguration() {
  return {
    ...
    sidebar: {
      ...
      backButton: document.getElementById('btBack'),
...
function webViewerLoad() {
    var temp = location.search.split('mybook=')[1];
    var mybook = temp.split('&')[0];
    mypage = parseInt(temp.split('&')[1]);
    DEFAULT_URL = mybook;
...
function myFunction() {
    PDFViewerApplication.page = mypage;
}
